...
if(!isset($_SESSION['nombre'])){
  ...
  if($_SESSION['escritorio'] == 1){
    ...
    //variables para obtener las compras del dia
    $resptac = $consulta->totalCompraHoy();
    $regc = $resptac->fetch_object();
    $totalc = $regc->total_compra;
    //variables para obtener las ventas del dia
    $resptav = $consulta->totalVentaHoy();
    $regv = $resptav->fetch_object();
    ...
    while ($regfechac = $compras10->fetch_object()) {
      $fechac = $fechac.'"'.$regfechac->fecha.'",';
      $totalesc = $totalesc.$regfechac->total.',';
    }

    //quitamos la ultima coma lugo del ultimo elemento del while
  ...
  <script>
    ...
    var compras = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '# Comras en $ de los últimos 10 días',
